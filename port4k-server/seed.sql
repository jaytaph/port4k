...
-- =========================
INSERT INTO accounts (username, role, password_hash, xp, health, coins)
VALUES
  ('admin',  'admin',  '$argon2id$v=19$m=4096,t=3,p=1$YTRucTM0d2JrMmYwMDAwMA$ys7sXXH6ETEFmIVysP4fW6YQo5s6V/hy2VLrNF7CDEM', 100000, 100, 1000),
  ('alice',  'player', '$argon2id$v=19$m=4096,t=3,p=1$MWIya3JwNmNnZTQwMDAwMA$jbsb0ayARAcFOHJ+tLIIR/mhd7ocQpOp0gTrW8cKPoQ',  2500, 100, 1000),
  ('bob',    'player', '$argon2id$v=19$m=4096,t=3,p=1$ajlzMXB4Nm5sMHIwMDAwMA$msXwjUslddp3j8B7vRcPRXn84cAsXH2oPbqEjwl2yw4',  1500, 100, 1000),
  ('carol',  'player', '$argon2id$v=19$m=4096,t=3,p=1$c3NudWZsM3UycWgwMDAwMA$rmhw1AzK4zZtbAEJyzKWaAMV56I5H4fF5qDvOWSGYPM',  500, 100, 1000)
ON CONFLICT (username) DO NOTHING;
--
-- -- ======================================
-- -- ZONES
-- -- ======================================
INSERT INTO zones (id, key, title)
VALUES
  ('9c6fc5e3-8401-44aa-b318-3d85c1ff7873', 'hub',     'The Central Hub'),
  ('efe21e05-18db-4615-95a8-45c740a97dee', 'crypt',   'Forgotten Crypt')
